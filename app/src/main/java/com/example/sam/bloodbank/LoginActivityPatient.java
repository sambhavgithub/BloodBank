...
public class LoginActivityPatient extends AppCompatActivity {
    ...
    TextView createaccount, forgotpassword, signasdonor, signasbloodbank;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()){
                                    startActivity(new Intent(LoginActivityPatient.this, seekerPage.class));
                                    Toast.makeText(LoginActivityPatient.this, "Success", Toast.LENGTH_SHORT).show();
                                }
                                else
                                    Toast.makeText(LoginActivityPatient.this, "Unsuccessful", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
        ...
        createaccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivityPatient.this, SeekerRegistration.class));
            }
        });
        ...
        signasdonor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivityPatient.this, LoginActivityDonor.class));
            }
        });
        signasbloodbank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivityPatient.this, LoginActivityBloodBank.class));
            }
        });
    }
}
